...
public class ToolRackBlockEntityRenderer implements BlockEntityRenderer<ToolRackBlockEntity> {
    ...
    @Override
    public void render(ToolRackBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
        ...
        if (!itemStack.isEmpty()) {
            ...
            Direction facing = blockState.getValue(ToolRackBlock.FACING);
